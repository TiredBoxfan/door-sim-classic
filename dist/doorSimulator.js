...
//Changing strings
let DoorState = "The door is currently in a 'closed' state.\nYou contemplate what could be behind it.";
let Floorstate = "The floor is cold and unforgiving, \nholding battlescars from the many who have walked across it.";
let LookAtValue = "You are in a small room, there is a door in front of you.\nThe door is a standard 'pull to open' model featuring a rotatable knob.\nThere is a light above you though no apparent way to turn it on or off.\n";
let PlayerStatus = "You are a sturdy creature fond of drink and industry.";
...
async function main() {
    ...
    let subtitle = "A Tale of One Door";
    do {
        //variables and such
        let left = false; //knob direction **BAD**
        let right = false; //knob direction **BAD**
        let firmness = false; //is the command firm
        let stepback = false; //has the player stepped back **BAD**
        let sword = false; //is the player holding a sword
        let iceproof = false; //is the player iceproof
        let open = false; //true if door is open **What?**
        let lights = true; //true = on, false = off
        //Not important variables
        let footpain = false;
        let nosebleed = false;
        let turnstaken = 0; //Turns taken
        let handstate = 0; //The state of the player's hand
        let direction = 0; //Direction the player is looking, 0 is at the door and all other directions are clockwise relative to this
        /*
        ...
        */
        ...
        do {
            ...
            //Grabbing
            else if ((userInput.includes("grab") ||
                ...
                if ((userInput.includes("hand") && 0 < wordCheckP("hand")) ||
                    userInput.includes("grasp") ||
                    userInput.includes("hold") ||
                    userInput.includes("grab")) {
                    if (wordOrder("hand", "door") ||
                        userInput.includes("grasp") ||
            ...
            //Rotating the door knob
                ...
                if ((wordOrder("turn", "knob") && userInput.includes("knob")) ||
                    ...
                    if ((wordOrder("knob", "left") && userInput.includes("left")) ||
            ...
            else if ((firmness == true && handstate == 1) ||
...
async function newgameplus(iceoff) {
    clear();
...
//# sourceMappingURL=doorSimulator.js.map