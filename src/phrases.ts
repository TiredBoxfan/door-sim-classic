...
export function help(): void {
    ...
    write(
        "In this game your main goal is to [open] a [door]\n\n" +
...
export function NGPlus(): void {
    //Prints the new game plus opening addition
    write(
        "In this new game plus, you have access to a bunch more commands with\n" +
...
export function opening(subtitle: string): void {
